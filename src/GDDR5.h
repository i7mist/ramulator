...
public:
    ...
    struct OrgEntry {
        ...
        {  512, 16, {0, 1, 4, 2, 1<<12, 1<<7}}, {  512, 32, {0, 1, 4, 2, 1<<12, 1<<6}},
        {1<<10, 16, {0, 1, 4, 4, 1<<12, 1<<7}}, {1<<10, 32, {0, 1, 4, 4, 1<<12, 1<<6}},
        {2<<10, 16, {0, 1, 4, 4, 1<<13, 1<<7}}, {2<<10, 32, {0, 1, 4, 4, 1<<13, 1<<6}},
        {4<<10, 16, {0, 1, 4, 4, 1<<14, 1<<7}}, {2<<10, 32, {0, 1, 4, 4, 1<<14, 1<<6}},
        {8<<10, 16, {0, 1, 4, 4, 1<<14, 1<<8}}, {8<<10, 32, {0, 1, 4, 4, 1<<14, 1<<7}}
    }, org_entry;
